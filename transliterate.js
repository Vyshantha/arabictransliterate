    ...
    for (let u = 0 ; u < textAr.length ; u++ ) {
      if (textAr[u].indexOf("\n") > -1) {
        ...
        /* if (textVocalisation.indexOf(textAr[u-1]) > -1) {
          ...
          /* if (arabicToLatin[textAr[u-2]] == "l") {
            resultLa = resultLa.slice(0, -1) + resultLa[resultLa.length - 3]; // TODO Shadda rules - لَّ
          } else { */
